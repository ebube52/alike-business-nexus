...
const ConnectingAnimation = () => {
  return (
    <div className="relative w-full h-64 flex items-center justify-center overflow-hidden">
      ...
      {/* People/Nodes */}
      {/* Person 1 - Top Left */}
      <div className="absolute top-8 left-8 bg-blue-500 p-3 rounded-full shadow-lg animate-[fade-in_1s_ease-out_0.2s_both]">
        <Users className="h-6 w-6 text-white" />
      </div>

      {/* Person 2 - Top Right */}
      <div className="absolute top-8 right-8 bg-green-500 p-3 rounded-full shadow-lg animate-[fade-in_1s_ease-out_0.7s_both]">
        <Users className="h-6 w-6 text-white" />
      </div>

      {/* Person 3 - Bottom Left */}
      <div className="absolute bottom-8 left-8 bg-purple-500 p-3 rounded-full shadow-lg animate-[fade-in_1s_ease-out_1.2s_both]">
        <Users className="h-6 w-6 text-white" />
      </div>

      {/* Person 4 - Bottom Right */}
      <div className="absolute bottom-8 right-8 bg-red-500 p-3 rounded-full shadow-lg animate-[fade-in_1s_ease-out_1.7s_both]">
        <Users className="h-6 w-6 text-white" />
      </div>
